...
| 8 | **Amazon Bedrock and other model providers** are not named in the subprocessor register, which lists five entities. Reco publicly documents Bedrock use. | ISO 42001 and EU AI Act transparency normally expect explicit model-provider disclosure rather than inheritance under a cloud entry. | |
...
| # | Question | Answer |
|---|---|---|
| 13 | Is there a **FedRAMP or GovRAMP/TX-RAMP** ambition? AppOmni holds a FedRAMP Moderate ATO and TX-RAMP and appears to be the only pure-play SSPM in the marketplace at any status. Reco just opened a Texas office. TX-RAMP is the cheaper near-term counter. | |
